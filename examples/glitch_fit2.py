...
def loss_fn(params, inputs, targets, model):
    ...
    loss = jnp.sum((targets - prediction)**2) + inputs[-1]**2 * jnp.sum((params[3] + params[4]*inputs[0])**2)
    return loss
...
def plot(n, nu, a0, a1, a2, a3, a4, b0, b1, tau, phi):
...
def main():
    ...
    a0_init, a1_init, a2_init, a3_init, a4_init = (1.5*delta_nu, delta_nu, 5e-2, 0.0, 0.0)
    ...
    if args.showplots:
        plot(n, nu, a0_fit, a1_fit, a2_fit, a3_fit, a4_fit, b0_fit, b1_fit, tau_fit, phi_fit)
