...
\end{equation}
%
where \(\alpha\) is the amplitude and \(\lambda\) is the length scale.
...
relations with global stellar parameters (nu max etc.). Subsequently, we update
the prior by fitting to stellar model frequencies (\todo{add grid details}).
