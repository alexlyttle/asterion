...
\documentclass[linenumbers,modern]{aastex631}
...
\usepackage{siunitx}
\sisetup{separate-uncertainty,range-units=single,multi-part-units=single}
...
and in several other high signal-to-noise stars SOME REFS. The two dominant
in these stars are due to the second ionisation of helium near the stellar
surface and the base of the convective zone. Naturally, fitting these glitches
provide insight into the helium abundance and convective boundary respectively.
...
%         ,\,
%         \begin{bmatrix}
%             \bm K_n + \bm{\mathcal{I}} \odot (\bm\sigma_n^2 + \delta) & 
%             \bm K_{n, \npred}\\
%             \bm K_{\npred, n} & \bm K_{\npred}
%         \end{bmatrix}
%     \right).
